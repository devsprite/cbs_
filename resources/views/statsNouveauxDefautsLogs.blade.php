                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <table id="example" class="table table-hover">
                                        ...
                                        <tbody>
                                        @foreach($news as $new)
                                            @if(isset($new[0]->defaut))
                                            <tr>
                                                <td>
                                                    <p class="description">{{(isset($new[0]->description))?$new[0]->description:""}}</p>
                                                    <small>{{(isset($new[0]->defaut))?$new[0]->defaut:""}}</small>
                                                </td>
                                                <?php $cpt = 0 ?>
                                                @for($i=10; $i>=0 ; $i--)
