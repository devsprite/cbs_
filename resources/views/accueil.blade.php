...
<div class="row tile_count">
    ...
    <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count hidden-print">
        <div class="left"></div>
        <div class="right">
            <span class="count_top"><i class="fa"></i></span>
            <div class="count"></div>
        ...
        <div class="x_content">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6" style="overflow:hidden;">
                    ...
                    <h4 style="margin:18px">Perte de tri totale - {{ intval($sumDatas['totalRejetCBS'][0]->moyenne) }}
...
<footer>
    <div class="row">
        <p class="pull-right">Stats CBS - LOPEZ Dominique <span class="lead"> <i class="fa fa-paw"></i> Stats CBS</span>
        </p>
    </div>
    <div class="clearfix"></div>
</footer>
